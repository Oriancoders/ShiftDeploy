            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="grid lg:grid-cols-2 gap-16 mb-20 p-2">
                ...
                <div className="h-fit">
                  ...
                  <img src="https://res.cloudinary.com/dbazbq7u9/image/upload/v1764979478/key_stats_u8ych3.png" alt="Project scope and delivery summary" loading="lazy" decoding="async" className="w-full h-52 sm:h-64 mb-6 object-contain" />
                </div>
              </div>
            </div>
          </section>
                  ...
                  <div key={feature?.id ?? feature?.slug ?? feature?.title ?? feature?.name ?? index} className="bg-white shadow-md rounded-2xl p-6 sm:p-8">
                    <div className="flex items-start sm:gap-x-6">
                      ...
                      <div className="flex-1">
                        <h3 className="text-lg sm:text-2xl font-semibold text-primaryBlue mb-4">{feature.title}</h3>
                    ...
                    <div className="space-y-6 bg-white rounded-2xl p-6 sm:p-8 shadow-md sm:hover:shadow-xl transition-all duration-300">
                      ...
                      <div className="flex-1">
                        <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
                          <h3 className="text-lg sm:text-2xl font-semibold text-primaryBlue">{phase.phase}</h3>
                        </div>
          ...
          <section className="py-20 bg-primaryBlue">
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
              <motion.div
                ...
                className="text-center mb-16"
              >
                <h2 className="text-3xl sm:text-4xl lg:text-5xl font-semibold text-white mb-8">
                  Results & Impact
                </h2>

...
const BuildHero = () => {
  ...
  const progressValue = useMotionValue(42);
  ...
  useEffect(() => {
    ...
    const controls = animate(progressValue, endValue, {
      delay: 1,
      duration: 0.9,
      ease: "easeOut",
      onUpdate: (v) => {
        setAnimatedNumbers({ score: Math.round(v) });
      },
    });
        ...
        <div className="grid lg:grid-cols-2 gap-4 sm:gap-8 lg:gap-12 xl:gap-16 sm:items-center">
          <div className="flex flex-col lg:items-start sm:items-center">
            <CursorFollower
              text={
                <p className="flex items-center justify-center gap-x-2 italic">
                  ShiftBuild <ArrowRight size={16} /> Scalable Structure <ArrowRight size={16} /> Growth Ready
                </p>
              }
            ...
            >
              ...
              <span className="font-semibold text-[#0C1F3A]"> No fragile rebuild cycle. No technical debt trap.</span>
            </motion.p>
          ...
          >
            <div className="relative w-full max-w-sm sm:max-w-md">
              <div className="relative w-64 h-64 sm:w-72 sm:h-72 md:w-80 md:h-80 mx-auto">
                  ...
                  <div className="w-full h-full rounded-full bg-gradient-to-br from-blue-50 via-blue-100 to-orange-50 p-6 relative overflow-hidden">
                    <div className="w-full h-full rounded-full bg-white shadow-inner flex items-center justify-center relative">
                      <div className="text-center z-10">
                        ...
                        <div className="text-lg font-semibold text-primaryBlue">Build Readiness</div>
                        <div className="text-sm text-primaryBlue/60">Scalable Site Score</div>
                      </div>
                ...
                <div className="absolute top-4 left-1/2 transform -translate-x-1/2 text-xs sm:text-sm font-semibold text-primaryOrange">STATIC</div>
                <div className="absolute top-1/2 right-4 transform -translate-y-1/2 text-xs sm:text-sm font-semibold text-primaryBlue">SCALABLE</div>
              </div>
              ...
              >
                <div className="flex items-center gap-1 sm:gap-2">
                  ...
                  <div>
                    <div className="text-xs font-medium opacity-90">Modular Pages</div>
              ...
              >
                <div className="flex items-center gap-1 sm:gap-2">
                  ...
                  <div>
                    <div className="text-xs font-medium opacity-90">Technical Debt</div>
                    <div className="text-sm sm:text-lg font-bold">Reduced</div>
                  </div>
                </div>
              </motion.div>
              ...
              >
                <div className="flex items-center gap-1 sm:gap-2">
                  ...
                  <div>
                    <div className="text-xs font-medium opacity-90">Future Optimized</div>
                    <div className="text-sm sm:text-lg font-bold">Yes</div>
                  </div>
                </div>
              </motion.div>

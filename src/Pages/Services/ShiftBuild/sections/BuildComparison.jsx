...
export const BuildComparison = () => {
  ...
  const beforeMetrics = [
    { label: "Redesign Frequency", value: "3-5 Years", bad: true },
    { label: "Update Flexibility", value: "Low", bad: true },
    { label: "Technical Debt", value: "High", bad: true },
    { label: "Growth Readiness", value: "Limited", bad: true },
  ];

  const afterMetrics = [
    { label: "Redesign Frequency", value: "Reduced", bad: false },
    { label: "Update Flexibility", value: "High", bad: false },
    { label: "Technical Debt", value: "Controlled", bad: false },
    { label: "Growth Readiness", value: "Built-In", bad: false },
  ];

  const beforeIssues = [
    "Outdated templates and rigid structure",
    "Patchwork plugins with maintenance risk",
    "Not built for SEO, speed, or CRO iteration",
    "Expensive redesign dependency cycle",
  ];

  const afterOptimizations = [
    "Modular architecture for scalable updates",
    "Performance and CRO-ready foundation",
    "SEO-ready technical structure",
    "Lifecycle-oriented growth implementation",
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-3xl sm:text-5xl md:text-6xl font-semibold text-primaryBlue mb-6">
            The <span className="text-primaryOrange">ShiftBuild</span> Difference
          </h2>
          <p className="sm:text-xl text-gray-600 max-w-3xl mx-auto">
            Build once with the right foundations, then improve continuously without costly rebuild cycles.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-7 gap-6 lg:gap-4 items-stretch">
          ...
          >
            ...
            <div className="text-center mb-6">
              ...
              <h3 className="text-xl md:text-2xl font-semibold text-primaryOrange">Traditional Build</h3>
            </div>
          ...
          >
            ...
            <div className="text-center mb-6">
              ...
              <h3 className="text-xl md:text-2xl font-semibold text-primaryBlue">ShiftBuild Optimized</h3>
            </div>
        ...
        >
          <CursorFollower
            text="We build with tomorrow in mind, so your business can improve continuously without expensive rebuild cycles."

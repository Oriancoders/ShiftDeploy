        ...
        <div className="grid grid-cols-1 lg:grid-cols-7 gap-6 lg:gap-4 items-stretch">
          ...
          >
            ...
            <div className="text-center mb-6">
              ...
              <h3 className="text-xl md:text-2xl font-bold text-primaryOrange">Traditional Build</h3>
            </div>
          ...
          >
            ...
            <div className="text-center mb-6">
              ...
              <h3 className="text-xl md:text-2xl font-bold text-primaryBlue">ShiftBuild Optimized</h3>
            </div>

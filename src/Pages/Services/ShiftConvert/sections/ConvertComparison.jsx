...
export const ConvertComparison = () => {
  ...
  const beforeMetrics = [
    { label: "Landing Conversion", value: "1.2%", bad: true },
    { label: "Form Completion", value: "24%", bad: true },
    { label: "Bounce Rate", value: "71%", bad: true },
    { label: "Qualified Leads", value: "Low", bad: true },
  ];

  const afterMetrics = [
    { label: "Landing Conversion", value: "5.4%", bad: false },
    { label: "Form Completion", value: "62%", bad: false },
    { label: "Bounce Rate", value: "38%", bad: false },
    { label: "Qualified Leads", value: "High", bad: false },
  ];

  const beforeIssues = [
    "Generic headline with weak value promise",
    "CTA buried below competing elements",
    "Long, unclear lead capture forms",
    "Minimal trust and proof architecture",
  ];

  const afterOptimizations = [
    "Outcome-first positioning and copy rewrite",
    "High-visibility CTA hierarchy",
    "Simplified forms with better intent filtering",
    "Proof-led design with strategic trust cues",
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-3xl sm:text-5xl md:text-6xl font-bold text-primaryBlue mb-6">
            The <span className="text-primaryOrange">Conversion</span> Difference
          </h2>
          <p className="sm:text-xl text-gray-600 max-w-3xl mx-auto">
            See what changes when conversion strategy is applied with the same rigor as engineering.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-7 gap-6 lg:gap-4 items-stretch">
          ...
          >
            ...
            <div className="text-center mb-6">
              ...
              <h3 className="text-xl md:text-2xl font-bold text-primaryOrange">Generic Funnel</h3>
            </div>
          ...
          >
            ...
            <div className="text-center mb-6">
              ...
              <h3 className="text-xl md:text-2xl font-bold text-primaryBlue">ShiftConvert Optimized</h3>
            </div>
        ...
        >
          <CursorFollower
            text="We map your buyer intent first, then redesign each decision step for conversion confidence."
...
export default ConvertComparison;

  ...
  const plans = [
    {
      ...
      price: "$397",
      description: "Funnel & UX Diagnostic",
      features: [
        "End-to-end funnel teardown",
        "Messaging and CTA clarity review",
        "Trust and persuasion gap analysis",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Clear scope, clear deliverables, no hidden retainers.
          </p>
        </motion.div>
        ...
        >
          <div className="bg-white border border-gray-200 rounded-xl p-6 max-w-2xl mx-auto">
            <p className="text-gray-600 mb-4">
              <strong>Focus:</strong> Improve qualified conversion outcomes from your existing traffic.
            </p>
            <p className="text-sm text-gray-500">
              Engagement structure depends on your funnel depth, traffic profile, and implementation requirements.
            </p>
          </div>
        </motion.div>
      </div>

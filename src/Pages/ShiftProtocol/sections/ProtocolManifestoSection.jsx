  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 opacity-20">
        <div className="absolute top-1/4 left-1/4 size-96 bg-blue-200 rounded-full blur-3xl animate-pulse"></div>
        <div className="absolute bottom-1/4 right-1/4 size-96 bg-orange-200 rounded-full blur-3xl animate-pulse delay-1000"></div>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-6 text-center relative z-10">
        ...
        >
          ...
          {/* Main Headline */}
          <h1 className="text-3xl sm:text-5xl md:text-7xl font-semibold text-primaryBlue mb-8 leading-tight">

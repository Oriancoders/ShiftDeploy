  ...
  const navItems = [
    {
      ...
      path: '/services',
      subPaths: [
        { label: 'Web design & development', path: '/services/shiftbuild' },
        { label: 'Website speed optimisation', path: '/services/shiftspeed' },
        { label: 'Conversion rate optimisation', path: '/services/shiftconvert' },
        { label: 'Website maintenance & support', path: '/services/shiftflow' },
      ],
    },

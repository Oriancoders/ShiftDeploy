  ...
  const navItems = [
    {
      ...
      path: '/services',
      subPaths: [
        { label: 'Get found by more customers', path: '/services/shiftbuild' },
        { label: 'Never miss a call or enquiry', path: '/services/shiftspeed' },
        { label: 'Win more jobs', path: '/services/shiftconvert' },

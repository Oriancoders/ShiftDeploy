...
export default function ProblemCard() {
  return (
    ...
    >
      <div className="absolute top-0 right-0 size-32 bg-red-50 rounded-bl-full -mr-10 -mt-10 z-0 transition-transform group-hover:scale-110 duration-500" />

      <div className="size-14 bg-red-50/80 rounded-2xl flex items-center justify-center mb-8 relative z-10 border border-red-100">
        <Clock className="size-7 text-red-500" />
      </div>
      <h3 className="text-2xl md:text-3xl font-semibold mb-6 text-gray-800 relative z-10 tracking-tight">Without Digital Receptionist</h3>

      <ul className="gap-y-5 mb-10 flex-grow relative z-10">
        {problemItems.map((item, i) => (
          ...
          >
            <div className="size-6 rounded-full bg-red-50 flex items-center justify-center mr-4 flex-shrink-0 mt-0.5">

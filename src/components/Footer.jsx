...
const columns = [
  {
    ...
    links: [
      ...
      { name: 'Web design & development', href: '/services/shiftbuild' },
      { name: 'Website speed optimisation', href: '/services/shiftspeed' },
      { name: 'Conversion rate optimisation', href: '/services/shiftconvert' },
      { name: 'Website maintenance & support', href: '/services/shiftflow' },

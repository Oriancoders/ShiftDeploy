...
export async function GET() {
  ...
  const lines = [
    '# ShiftDeploy',
    '',
    '> ShiftDeploy helps UK service businesses stop losing work: an AI receptionist',
    '> and telephone answering service, web design and local SEO, website speed and',
    '> conversion optimisation, and business automation. Free check, plain English.',
    '',
    '## Services',
    '',
